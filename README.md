...
Study sits beside the lexicon. It has three labeled parts. In context is Matthew Henry’s Concise Commentary, the note this app already kept for the verse in its place. A note is often written for a few verses together. The screen says which verses it covers. Then (original audience) is the introduction unfoldingWord wrote for that book: who wrote it, who received it, and the religious and cultural world the notes already separate from translator instructions. The screen says the note is about the whole book, not a comment written for this verse alone. Books that source does not cover, including Psalms and Isaiah, say there is no note. Today is Charles Spurgeon’s Faith’s Checkbook, and only when this verse is the text of that day’s reading. The title and his comment are his. A verse he did not write on says there is no note. None of the three parts is filled in with a new paragraph when the source is silent. The notes are in English. In Spanish and Portuguese the labels and empty states follow his language, and a line says the notes are in English. See `public/scripture/meaning-license.txt` and `public/scripture/study-license.txt`.
